...
local function GenerateModuleWrecks()
	...
	for i = 1, #moduleDefs do
		...
		wreck.metal = moduleDef.cost * 0.3
		wreck.reclaimtime = moduleDef.cost * 0.3
		...
		heap.metal = moduleDef.cost * 0.15
		heap.reclaimtime = moduleDef.cost * 0.15
