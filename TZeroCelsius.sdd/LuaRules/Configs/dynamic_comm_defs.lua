...
local moduleDefs = {
	...
	},
	{
		...
		description = "Autorepair - Commander self-repairs at +10 hp/s. Reduces Health by " .. 200*HP_MULT .. ". Limit: 8",
	...
	},
	{
		...
		description = "Ablative Armour Plates - Provides " .. 800*HP_MULT .. " health. Limit: 8",
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.healthBonus = (sharedData.healthBonus or 0) + 800*HP_MULT
		end
	},
	{
		name = "module_heavy_armor",
		humanName = "High Density Plating",
		description = "High Density Plating - Provides " .. 2500*HP_MULT .. " health but reduces movement by 6%. " .. 
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.healthBonus = (sharedData.healthBonus or 0) + 2500*HP_MULT
			sharedData.speedMult = (sharedData.speedMult or 1) - 0.06
		end
	},
	{
		name = "module_dmg_booster",
		humanName = "Damage Booster",
		description = "Damage Booster - Increases damage by 12% but reduces range by 6%.  Limit: 8",
		...
		applicationFunction = function (modules, sharedData)
			...
			sharedData.rangeMult = (sharedData.rangeMult or 1) - 0.06
		end
	},
	{
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.speedMult = (sharedData.speedMult or 1) + 0.10
		end
	},
	{
		name = "module_adv_targeting",
		humanName = "Adv. Targeting System",
		description = "Advanced Targeting System - Increases range by 12% but reduces speed by 6%. Limit: 8",
		...
		slotType = "module",
		applicationFunction = function (modules, sharedData)
			sharedData.rangeMult = (sharedData.rangeMult or 1) + 0.12
			sharedData.speedMult = (sharedData.speedMult or 1) - 0.06
		end
	},
	{
		...
		description = "CarRepairer's Nanolathe - Increases build power and energy production by 4, but reduces health by " .. 100*HP_MULT .. ". Limit: 8",
